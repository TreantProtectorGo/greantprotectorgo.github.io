import { X as defineComponent, at as openBlock, J as createElementBlock, aA as renderSlot, p as withModifiers, bh as ref, an as onMounted, ar as onUnmounted, G as computed, aT as watch, L as createBaseVNode, bu as normalizeClass, a_ as withDirectives, n as vShow } from './common/runtime-dom.esm-bundler-019b41aa.js';
...
const da = { class: "qrcode-stream-wrapper" }, pa = { class: "qrcode-stream-overlay" }, ha = /* @__PURE__ */ defineComponent({
  __name: "QrcodeStream",
  props: {
    constraints: {
      type: Object,
  ...
  setup(n, { emit: a }) {
    const o = n, u = ref(), d = ref(), p = ref(), m = ref(!1), w = ref(!1);
    onMounted(() => {
      w.value = !0;
    }), onUnmounted(() => {
      bt();
    ...
    const v = computed(() => S.value.shouldStream && m.value);
    watch(v, (C) => {
      if (C) {
        b(u.value), b(d.value);
    ...
    return (C, E) => (openBlock(), createElementBlock("div", da, [
      createBaseVNode("video", {
        ref_key: "videoRef",
        ref: p,
        class: normalizeClass([{ "qrcode-stream-camera--hidden": !v.value }, "qrcode-stream-camera"]),
        autoplay: "",
        muted: "",
        playsinline: ""
      }, null, 2),
...
const ma = (n, a) => {
  ...
  for (const [u, d] of a)
    o[u] = d;
  return o;
}, va = /* @__PURE__ */ ma(ha, [["__scopeId", "data-v-44e7ec8a"]]), ya = /* @__PURE__ */ defineComponent({
  ...
  setup(n, { emit: a }) {
    ...
    return (d, p) => (openBlock(), createElementBlock("input", {
      onChange: u,
      type: "file",
      name: "image",
      accept: "image/*",
...
}), ga = ["onDrop"], Ca = /* @__PURE__ */ defineComponent({
  ...
  setup(n, { emit: a }) {
    ...
    return (p, m) => (openBlock(), createElementBlock("div", {
      onDrop: withModifiers(d, ["prevent", "stop"]),
      onDragenter: m[0] || (m[0] = withModifiers((w) => u(!0), ["prevent", "stop"])),
      onDragleave: m[1] || (m[1] = withModifiers((w) => u(!1), ["prevent", "stop"])),
      onDragover: m[2] || (m[2] = withModifiers(() => {
      }, ["prevent", "stop"]))
    }, [
...
export { ya as QrcodeCapture, Ca as QrcodeDropZone, va as QrcodeStream, _a as VueQrcodeReader, wa as install };
